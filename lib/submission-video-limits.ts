...
export const SUBMISSION_VIDEO_R2_UPLOAD_TIMEOUT_MS = 15 * 60 * 1000;

export const SUBMISSION_VIDEO_PRESIGNED_UPLOAD_EXPIRY_SECONDS = 30 * 60;

export const SUBMISSION_VIDEO_UPLOAD_FAILED_MESSAGE =
