  ...
  return (
    <article className="mx-auto w-full max-w-xl">
      ...
      {!isFreeSelected && !isLoggedInWithPendingCheckout ? (
        <section className="mt-6 rounded-2xl border border-[#2b3650] border-l-4 border-l-[#52B788] bg-[#0A1628] px-5 py-6 sm:px-6">
      ...
      {isLoggedInWithPendingCheckout ? (
        ...
        <form className="mt-6 space-y-4" onSubmit={onSignupSubmit}>
          ...
          <button
            type="submit"
            disabled={Boolean(signupLoading)}
            className="w-full rounded-full bg-[#22c55e] px-5 py-3.5 text-base font-semibold text-black transition hover:bg-[#35db72] disabled:cursor-not-allowed disabled:opacity-50"
          >
      ...
      {!isLoggedInWithPendingCheckout && !isFreeSelected ? (
        <section className="mt-8 border-t border-[#2b3650] pt-8">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-[#2b3650] bg-[#0b1324]/60 p-4">
            ...
            <div className="rounded-xl border border-[#2b3650] bg-[#0b1324]/60 p-4">
              ...
              <p className="mt-2 text-xs leading-relaxed text-zinc-500">{eliteSignupDescription}</p>
              <button
                type="button"
