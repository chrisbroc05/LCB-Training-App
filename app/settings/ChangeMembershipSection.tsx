  ...
  return (
    <section className="mt-8 rounded-2xl border border-[#18243a] bg-[#0b1324]/80 p-6">
      ...
      <p className="mt-2 text-zinc-300">
        Switch to another membership tier anytime. Stripe will automatically apply prorated charges
        or credits.
      </p>

      {!hasSubscription ? (
        <p className="mt-4 text-sm text-zinc-400">
          No active subscription is connected to your account yet, so tier switching is unavailable.
        </p>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  >
                    {isPending ? "Updating..." : `Switch to ${tier.name}`}
                  </button>
                </div>
