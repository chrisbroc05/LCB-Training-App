...
function ProgramCheckoutSectionContent({
  ...
  const handleSignup = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    window.location.href = "/program?startCheckout=1";
  };
  ...
  if (isLoggedIn) {
    return (
      <div className="space-y-3">
        ...
        >
          {checkoutLoading ? "Redirecting to checkout..." : "Start the 12-Week Program"}
        </button>
  ...
  return (
    <div className="rounded-2xl border border-[#2b3650] bg-black/30 p-5 sm:p-6">
      ...
      <p className="mt-2 text-sm text-zinc-400">
        {authMode === "signup"
          ? "Set up your account first, then you will proceed to secure checkout for the 12-Week Coaching Program."
          : "Log in to continue to checkout for the 12-Week Coaching Program."}
      </p>
